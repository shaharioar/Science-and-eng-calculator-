...
public class TestCalculatorValue {
	...
	public static void main(String[] args) {
		...
		test = new CalculatorValue(1234567890123456L,0);						// Perform the test
		
		System.out.println("2. Input: 1234567890123456L,0");	
		...
		CalculatorValue t = new CalculatorValue(1234567890123456L,0);			// Set up the test
