 ...
 * @Version 2.o     The Square Root Version
 * 
 */

public class 
UNumber implements Comparable<UNumber> {
	...
	int i;
	public void sqrt( ) {
		UNumberWithSqrt temporary1, temporary2;
		temporary1 = new UNumberWithSqrt (this);            
		temporary2 = new UNumberWithSqrt (2);
		UNumberWithSqrt two = new UNumberWithSqrt (2);
		
		for(i=0;i<=25;i++) {                                           // The Number of digit has been indicated hare as loop
			 {
			}
			 temporary1.div(temporary2);                               // The UNnumber of divition funtion has been called here.
			 temporary2.add(temporary1);                               // The UNnumber of addition funtion has been called here.
			 temporary2.div(two);                                      // The UNnumber of divition funtion has been called here.
			 temporary1 = new UNumberWithSqrt (this) ;
			
			//System.out.println("The value of iteration " + i + " = " + temporary2.toDecimalString()); // Here the value has been print which will come from the Iteration.
		
			this.d =  temporary2.d;
			this.dP =  temporary2.dP;
			this.s =  temporary2.s;  
